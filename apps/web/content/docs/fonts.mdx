...
> The stylistic set number is font-specific: Vazirmatn renders Farsi digits with `ss01`, while Estedad uses `ss20`. Projects scaffolded through [/create](/create) or the CLI get the right setting automatically.
