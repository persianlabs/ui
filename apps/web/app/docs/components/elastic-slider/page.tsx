    ...
    <div className="flex gap-10">
      <article className="max-w-3xl min-w-0 flex-1">
        ...
        <p className="mt-3 leading-relaxed text-muted-foreground">
          A single-track, dual-thumb range slider built with the same
          direction-aware positioning as{" "}
          <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-sm">
            ElasticSlider
          </code>
          . Each thumb clamps against the other, so the minimum can never be
          dragged past the maximum or vice versa.
        </p>
        <div className="mt-4">
          <ComponentPreview
