...
import { BadgeDemoExample } from "@/components/examples/badge-demo"
import { BadgeIconExample } from "@/components/examples/badge-icon"
import { BadgeRtlExample } from "@/components/examples/badge-rtl"
...
const SOURCE_PATH = "apps/web/app/docs/components/badge/page.tsx"

import { badgeApi } from "./api-data"
...
const usageSnippet = `import { Badge } from "@/components/ui/badge"
...
export const badgeMarkdown = [
  ...
  "### Badge",
  "",
  apiRowsToMarkdownTable(badgeApi),
].join("\n")
    ...
    <div className="flex gap-10">
      <article className="max-w-3xl min-w-0 flex-1">
        <div className="flex flex-col items-end justify-between gap-3 sm:flex-row sm:items-center">
          ...
          <CopyMarkdownButton markdown={badgeMarkdown} />
        </div>
        ...
        <div className="mt-4">
          <ComponentPreview
            preview={<BadgeDemoExample />}
            code={
              <CodeBlock code={getExampleSource("badge-demo")} lang="tsx" />
            }
          />
        </div>
