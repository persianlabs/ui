...
import { LabelDemoExample } from "@/components/examples/label-demo"
import { LabelInputExample } from "@/components/examples/label-input"
import { LabelRtlExample } from "@/components/examples/label-rtl"
...
const SOURCE_PATH = "apps/web/app/docs/components/label/page.tsx"

import { labelApi } from "./api-data"
...
const usageSnippet = `import { Label } from "@/components/ui/label"

export function Example() {
  return <Label htmlFor="email">Email</Label>
}`

export const labelMarkdown = [
  "# Label",
  "",
  ...
  "### Label",
  "",
  apiRowsToMarkdownTable(labelApi),
].join("\n")
    ...
    <div className="flex gap-10">
      <article className="max-w-3xl min-w-0 flex-1">
        <div className="flex flex-col items-end justify-between gap-3 sm:flex-row sm:items-center">
          ...
          <CopyMarkdownButton markdown={labelMarkdown} />
        </div>
        ...
        <div className="mt-4">
          <ComponentPreview
            preview={<LabelDemoExample />}
            code={
              <CodeBlock code={getExampleSource("label-demo")} lang="tsx" />
            }
          />
        </div>
