...
import { AccordionDemoExample } from "@/components/examples/accordion-demo"
import { AccordionRtlExample } from "@/components/examples/accordion-rtl"
...
const SOURCE_PATH = "apps/web/app/docs/components/accordion/page.tsx"

import { accordionItemApi, accordionRootApi } from "./api-data"
...
const accordionMarkdown = [
  ...
  "### Accordion",
  "",
  apiRowsToMarkdownTable(accordionRootApi),
  "",
  "### AccordionItem",
  "",
  apiRowsToMarkdownTable(accordionItemApi),
].join("\n")
    ...
    <div className="flex gap-10">
      <article className="max-w-3xl min-w-0 flex-1">
        <div className="flex flex-col items-end justify-between gap-3 sm:flex-row sm:items-center">
          ...
          <CopyMarkdownButton markdown={accordionMarkdown} />
        </div>
        <p className="mt-3 max-w-2xl leading-relaxed text-muted-foreground">
          A vertically stacked set of interactive headings that each reveal a
          section of content. Built on Base UI&apos;s accordion primitive.
        </p>
        ...
        <div className="mt-4">
          <ComponentPreview
            preview={<AccordionDemoExample />}
            code={
              <CodeBlock code={getExampleSource("accordion-demo")} lang="tsx" />
            }
          />
        </div>
        ...
        <Tabs defaultValue="cli" className="mt-4">
          ...
          <TabsContent value="manual" className="mt-4">
            <Steps>
              ...
              <div className="mt-2">
                <CodeBlock
                  code={getComponentSource("accordion")}
                  lang="tsx"
