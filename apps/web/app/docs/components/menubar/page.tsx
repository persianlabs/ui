...
import { MenubarDemoExample } from "@/components/examples/menubar-demo"
import { MenubarRtlExample } from "@/components/examples/menubar-rtl"
...
const SOURCE_PATH = "apps/web/app/docs/components/menubar/page.tsx"

import { menubarMenuApi, menubarRootApi } from "./api-data"
...
export const menubarMarkdown = [
  ...
  "### Menubar",
  "",
  apiRowsToMarkdownTable(menubarRootApi),
  "",
  "### MenubarMenu",
  "",
  apiRowsToMarkdownTable(menubarMenuApi),
].join("\n")
    ...
    <div className="flex gap-10">
      <article className="max-w-3xl min-w-0 flex-1">
        <div className="flex flex-col items-end justify-between gap-3 sm:flex-row sm:items-center">
          ...
          <CopyMarkdownButton markdown={menubarMarkdown} />
        </div>
        <p className="mt-3 max-w-2xl leading-relaxed text-muted-foreground">
          A visually persistent menu common in desktop applications that
          provides quick access to a consistent set of commands. Built on Base
          UI&apos;s menubar primitive.
        </p>
        ...
        <div className="mt-4">
          <ComponentPreview
            preview={<MenubarDemoExample />}
            code={
              <CodeBlock code={getExampleSource("menubar-demo")} lang="tsx" />
            }
          />
        </div>
        ...
        <Tabs defaultValue="cli" className="mt-4">
          ...
          <TabsContent value="manual" className="mt-4">
            <Steps>
              ...
              <div className="mt-2">
                <CodeBlock
                  code={getComponentSource("menubar")}
                  lang="tsx"
        ...
        <div className="mt-8">
          ...
          <div className="mt-3">
            <ComponentPreview
              dir="rtl"
              preview={<MenubarRtlExample />}
              code={
                <CodeBlock code={getExampleSource("menubar-rtl")} lang="tsx" />
              }
            />
          </div>
        </div>
