...
// Ported from the shadcn create app's picker.tsx — a styled Base UI Menu
// used as the customizer dropdown. Icons come from lucide-react instead of
// the registry IconPlaceholder.
...
function PickerCheckboxItem({
  ...
  return (
    <MenuPrimitive.CheckboxItem
      ...
      checked={checked}
      className={cn(
        "relative flex cursor-default items-center gap-2 rounded-lg py-1.5 pr-8 pl-2 text-sm font-medium outline-hidden select-none **:text-neutral-100 focus:bg-neutral-600 focus:text-neutral-100 focus:**:text-neutral-100 data-disabled:pointer-events-none data-disabled:opacity-40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
...
function PickerSubTrigger({
  ...
  return (
    <MenuPrimitive.SubmenuTrigger
      ...
      className={cn(
        "flex cursor-default items-center gap-2 rounded-lg px-2 py-1.5 text-sm font-medium outline-hidden select-none **:text-neutral-100 focus:bg-neutral-600 focus:text-neutral-100 data-disabled:pointer-events-none data-disabled:opacity-50",
        className
      )}
      {...props}
    >
