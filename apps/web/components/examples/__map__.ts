...
export const exampleLoaders: Record<string, () => Promise<React.ComponentType>> = {
  ...
  "bounce-sidebar-demo": () => import("@/components/examples/bounce-sidebar-demo").then((m) => m.BounceSidebarDemoExample),
  "bounce-sidebar-rtl": () => import("@/components/examples/bounce-sidebar-rtl").then((m) => m.BounceSidebarRtlExample),
  ...
  "duration-picker-demo": () => import("@/components/examples/duration-picker-demo").then((m) => m.DurationPickerDemoExample),
  "duration-picker-rtl": () => import("@/components/examples/duration-picker-rtl").then((m) => m.DurationPickerRtlExample),
  ...
  "field-checkbox": () => import("@/components/examples/field-checkbox").then((m) => m.FieldCheckboxExample),
  "field-demo": () => import("@/components/examples/field-demo").then((m) => m.FieldDemoExample),
  "field-disabled": () => import("@/components/examples/field-disabled").then((m) => m.FieldDisabledExample),
  ...
  "field-input-group": () => import("@/components/examples/field-input-group").then((m) => m.FieldInputGroupExample),
  "field-required": () => import("@/components/examples/field-required").then((m) => m.FieldRequiredExample),
  "field-rtl": () => import("@/components/examples/field-rtl").then((m) => m.FieldRtlExample),
  "field-switch": () => import("@/components/examples/field-switch").then((m) => m.FieldSwitchExample),
  "field-textarea": () => import("@/components/examples/field-textarea").then((m) => m.FieldTextareaExample),
  "field-validity": () => import("@/components/examples/field-validity").then((m) => m.FieldValidityExample),
  ...
  "iran-map-picker-demo": () => import("@/components/examples/iran-map-picker-demo").then((m) => m.IranMapPickerDemoExample),
  "iran-map-picker-form": () => import("@/components/examples/iran-map-picker-form").then((m) => m.IranMapPickerFormExample),
  ...
  "national-id-input-demo": () => import("@/components/examples/national-id-input-demo").then((m) => m.NationalIdInputDemoExample),
  "national-id-input-rtl": () => import("@/components/examples/national-id-input-rtl").then((m) => m.NationalIdInputRtlExample),
  ...
  "normalize-persian-text-demo": () => import("@/components/examples/normalize-persian-text-demo").then((m) => m.NormalizePersianTextDemoExample),
  "normalize-persian-text-search": () => import("@/components/examples/normalize-persian-text-search").then((m) => m.NormalizePersianTextSearchExample),
  "number-to-persian-words-demo": () => import("@/components/examples/number-to-persian-words-demo").then((m) => m.NumberToPersianWordsDemoExample),
  "number-to-persian-words-ltr": () => import("@/components/examples/number-to-persian-words-ltr").then((m) => m.NumberToPersianWordsLtrExample),
  "number-to-persian-words-unit": () => import("@/components/examples/number-to-persian-words-unit").then((m) => m.NumberToPersianWordsUnitExample),
  ...
  "plate-input-controlled": () => import("@/components/examples/plate-input-controlled").then((m) => m.PlateInputControlledExample),
  "plate-input-demo": () => import("@/components/examples/plate-input-demo").then((m) => m.PlateInputDemoExample),
  "plate-input-paste": () => import("@/components/examples/plate-input-paste").then((m) => m.PlateInputPasteExample),
  "plate-input-rtl": () => import("@/components/examples/plate-input-rtl").then((m) => m.PlateInputRtlExample),
  "plate-input-wheelchair": () => import("@/components/examples/plate-input-wheelchair").then((m) => m.PlateInputWheelchairExample),
  ...
  "proximity-sidebar-demo": () => import("@/components/examples/proximity-sidebar-demo").then((m) => m.ProximitySidebarDemoExample),
  "proximity-sidebar-rtl": () => import("@/components/examples/proximity-sidebar-rtl").then((m) => m.ProximitySidebarRtlExample),
  ...
  "status-button-demo": () => import("@/components/examples/status-button-demo").then((m) => m.StatusButtonDemoExample),
  "status-button-form": () => import("@/components/examples/status-button-form").then((m) => m.StatusButtonFormExample),
  "status-button-rtl": () => import("@/components/examples/status-button-rtl").then((m) => m.StatusButtonRtlExample),
...
export type ExampleMap = {
  ...
  "normalize-persian-text-demo": React.ComponentType;
  "normalize-persian-text-search": React.ComponentType;
