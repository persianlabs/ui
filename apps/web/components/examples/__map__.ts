...
> = {
  ...
  "calendar-dropdown-miladi": () =>
    import("@/components/examples/calendar-dropdown-miladi").then(
      (m) => m.CalendarDropdownMiladiExample
    ),
  "calendar-dropdown": () =>
  ...
  "normalize-persian-text-demo": () =>
    import("@/components/examples/normalize-persian-text-demo").then(
      (m) => m.NormalizePersianTextDemoExample
    ),
  "normalize-persian-text-search": () =>
    import("@/components/examples/normalize-persian-text-search").then(
      (m) => m.NormalizePersianTextSearchExample
    ),
  ...
  "sidebar-demo": () =>
    import("@/components/examples/sidebar-demo").then(
      (m) => m.SidebarDemoExample
    ),
  "sidebar-rtl": () =>
    import("@/components/examples/sidebar-rtl").then(
      (m) => m.SidebarRtlExample
    ),
  "skeleton-card": () =>
